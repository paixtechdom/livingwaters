...
const BeninPage = () => {
  ...
  const location = Locations[language][2]
  useEffect(() => {
  ...
  return (
    <main className="center flex-col gap-[10vh] lg:gap-[15vh] mb-[10vh] lg:mb-[15vh]">
      <section className="w-full center text-center h-[70vh] pt-[15vh] relative">
        <div className="absolute top-0 left-0 h-full w-full bg-benin center flex-col">
            
          <BreadCrumbs
            text="text-gray-200"
            link={language == "eng" ? "Benin Republic" : "Republic du Bénin"}
          />
    ...
    <InfoCard
          ...
          img={`${backendLocation}/images/2025-let-us-pray-benin/IMG-20250520-WA0014.jpg`}
          btn={
  ...
  <div className="flex flex-col gap-9">
        <InfoCard 
          ...
          img={`${backendLocation}/images/2025-let-us-pray-benin/IMG-20250520-WA0076.jpg`}
          btn={
      ...
      <ImageText 
      img1={`${backendLocation}/images/2025-let-us-pray-benin/IMG-20250518-WA0051.jpg`}
      img2={`${backendLocation}/images/2025-let-us-pray-benin/IMG-20250520-WA0132.jpg`}
