...
export const ConfirmBox = ({ prompt, deleting, setPromptAction, DeleteMessage, showPrompt, setShowPrompt }) => {
    ...
    return(
        <div className="h-screen w-full center fixed top-0 left-0 bg-black bg-opacity-10 z-[60]">
            <div className={`min-h-[40vh] bg-gradient-to-r from-blue-50 to-orange-50 w-10/12 md:w-9/12 lg:w-7/12 xl:w-5/12 rounded-2xl shadow-xl center flex-col p-9 py-[7vh] gap-2 transition-all duration-500 ${showPrompt ? '' : 'scale-[0] opacity-0'}`}>
