...
const MesagesList = () => {
    ...
    return(
        ...
        <div className="flex items-center w-11/12 lg:w-10/12 xl:w-9/12 flex-col gap-[5vh] relative min-h-[100vh] mt-3">
            <h1 className="text-2xl font-bold">Download our Messages</h1>
