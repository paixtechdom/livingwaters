    ...
    return(
        <section className="center w-full bg-footerBg bg-center bg-no-repeat bg-fixed bg-cover relative py-[10vh] text-sm">
            ...
            <div className="w-11/12 lg:w-10/12 flex flex-col gap-9 md:gap-16 lg:gap-9 text-white z-10">
                <div className="w-full flex flex-col lg:flex-row justify-between gap-9 md:gap-16 lg:gap-9 text-white z-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-9 lg:w-4/12 mt-6 lg:mt-0">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <h3 className="font-bold text-blue-100 text-lg">{language == "eng" ? "Social Media": "Médias sociaux"}</h3>
                            <div className="flex flex-col gap-3">
                                {
                                    Contacts[language].social_media.map((contact, i) => (
                                        <Link key={i}>
                                            {contact.title}
