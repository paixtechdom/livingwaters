...
const { showAlert, setShowAlert, alertType, alertMessage } = useContext(AppContext)
    ...
    return(<></>
        ...
        //     <div className={`min-h-[40vh] bg-gradient-to-r from-blue-100 to-orange-100 w-full md:w-9/12 lg:w-7/12 xl:w-6/12 rounded-t-2xl shadow-xl center flex-col p-9 py-[7vh] pb-[12vh] gap-2 transition-all duration-1000 ${show ? '' : 'translate-y-[100%]'}`}>
