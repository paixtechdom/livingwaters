...
export const Alert = () => {
    ...
    return(
        <div className="h-screen w-full flex justify-center items-end fixed top-0 left-0 bg-black bg-opacity-10 z-[60]">
            <div className={`min-h-[40vh] bg-gradient-to-r from-blue-100 to-orange-100 w-full md:w-9/12 lg:w-7/12 xl:w-6/12 rounded-t-2xl shadow-xl center flex-col p-9 py-[7vh] gap-2 transition-all duration-1000 ${show ? '' : 'translate-y-[100%]'}`}>
