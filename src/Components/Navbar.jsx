        ...
        <>
            {
                ...
                <nav className="flex items-center justify-between w-11/12 lg:w-10/12 xl:w-9/12">
                    ...
                    lg:flex-row lg:gap-0 lg:h-fit lg:top-0 lg:relative w-10/12 lg:border-0`}>
                        ...
                        <div className={`flex 
                        w-11/12 ${loggedIn && 'mt-6 flex-col '} gap-9 items-center lg:justify-end xl:justify-center lg:top-0 lg:flex-row  text-sm lg:gap-12 xl:gap-14 lg:w-full text-[#000000] lg:mt-0`}>
                            {
                                loggedIn &&
                                navs.map((nav, i) => (
