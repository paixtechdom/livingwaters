...
const Navbar = () => {
    ...
    return(
        <header className="center fixed top-0 left-0 h-[8vh] md:h-[10vh] lg:h-[13vh] w-full z-50 bg-gradient-to-r from-blue-50 to-orange-50 lg:border-0 shadow-lg">
            <nav className="flex items-center justify-between w-11/12 lg:w-10/12 xl:w-9/12">
                ...
                lg:flex-row lg:justify-center lg:gap-0 lg:h-fit lg:top-0 lg:relative w-10/12 lg:border-0`}>
                    ...
                    w-9/12 mt-6  gap-9 lg:justify-end xl:justify-center lg:top-0 lg:flex-row  text-sm lg:gap-12 xl:gap-14 lg:w-full text-[#000000] lg:mt-0`}>
                        {
                            navs.map((nav, i) => (
                    ...
                    <div className="flex justify-end mt-9 w-10/12  gap-5 flex-col lg:mt-0 lg:w-3/12 lg:flex-row">
